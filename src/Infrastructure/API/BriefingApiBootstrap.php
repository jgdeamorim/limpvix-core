...
use LimpVix\Infrastructure\API\AuthBootstrap;
...
class BriefingApiBootstrap
{
    ...
    public static function registerRoutes(): void
    {
        ...
        $jwtMiddleware = class_exists("LimpVix\\Infrastructure\\API\\AuthBootstrap") ? AuthBootstrap::getJwtMiddleware() : null;
        $briefingController = new BriefingController($createBriefingUseCase, $repository, $jwtMiddleware);
