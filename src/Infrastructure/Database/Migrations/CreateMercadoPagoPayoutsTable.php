 ...
 *
 * RESPONSABILIDADE:
 * - Criar tabela wp_limpvix_payouts (FIXED: era mp_payouts)
 ...
 * - Changed TABLE_NAME from 'limpvix_mp_payouts' to 'limpvix_payouts'
 * - Reason: WpPayoutRepository expects 'limpvix_payouts' (line 22)
 * - Impact: Bug caused ALL payout queries to fail (table not found)
 *
...
class CreateMercadoPagoPayoutsTable
{
     ...
     * Nome da tabela
     *
     * ✅ CRITICAL FIX: Changed from 'limpvix_mp_payouts' to 'limpvix_payouts'
     * to match WpPayoutRepository expectation (line 22).
     *
     * Bug identified: Table name mismatch caused all repository queries to fail.
     * Fixed in: Finance Core Stabilization Sprint (2026-02-12)
     */
    private const TABLE_NAME = 'limpvix_payouts';
