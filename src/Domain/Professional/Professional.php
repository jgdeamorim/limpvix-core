...
class Professional
{
    ...
    public function suspend(\DateTimeImmutable $until, string $reason, ?int $suspendedBy = null): void
    {
        ...
        $this->recordEvent(new Events\ProfessionalSuspended(
            $this->id,
            $reason,
            $until,
            $suspendedBy
    ...
    /**
     * Get service radius in kilometers (helper method)
     *
     * @return int Service radius in km
     */
    public function getServiceRadiusKm(): int { return $this->serviceRegion->getRadiusKm(); }
     ...
     *
     * Se true, EPI video selfie é obrigatório no check-in
     *
     * @return bool
     * @since GAP #1 - EPI selfie requirement
     */
    public function requiresEpi(): bool
    {
        return $this->hasEpi;
    }

    /**
     * Verifica quando foi o último check de EPI
     *
     * @return \DateTimeImmutable|null
     */
    public function getEpiLastCheck(): ?\DateTimeImmutable
    {
        return $this->epiLastCheck;
    }
